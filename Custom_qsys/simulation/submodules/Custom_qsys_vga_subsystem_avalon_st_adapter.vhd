-- Custom_qsys_vga_subsystem_avalon_st_adapter.vhd
...
entity Custom_qsys_vga_subsystem_avalon_st_adapter is
	generic (
		inBitsPerSymbol : integer := 10;
		inUsePackets    : integer := 1;
		inDataWidth     : integer := 30;
		inChannelWidth  : integer := 2;
		inErrorWidth    : integer := 0;
		inUseEmptyPort  : integer := 0;
		inUseValid      : integer := 1;
		inUseReady      : integer := 1;
		inReadyLatency  : integer := 0;
		outDataWidth    : integer := 30;
	...
	port (
		...
		in_0_data           : in  std_logic_vector(29 downto 0) := (others => '0'); --     in_0.data
		...
		in_0_channel        : in  std_logic_vector(1 downto 0)  := (others => '0'); --         .channel
		out_0_data          : out std_logic_vector(29 downto 0);                    --    out_0.data
		out_0_valid         : out std_logic;                                        --         .valid
		out_0_ready         : in  std_logic                     := '0';             --         .ready
		out_0_startofpacket : out std_logic;                                        --         .startofpacket
		out_0_endofpacket   : out std_logic                                         --         .endofpacket
	);
end entity Custom_qsys_vga_subsystem_avalon_st_adapter;

architecture rtl of Custom_qsys_vga_subsystem_avalon_st_adapter is
	component Custom_qsys_vga_subsystem_avalon_st_adapter_channel_adapter_0 is
		port (
			clk               : in  std_logic                     := 'X';             -- clk
			reset_n           : in  std_logic                     := 'X';             -- reset_n
			in_data           : in  std_logic_vector(29 downto 0) := (others => 'X'); -- data
			in_valid          : in  std_logic                     := 'X';             -- valid
			in_ready          : out std_logic;                                        -- ready
			in_startofpacket  : in  std_logic                     := 'X';             -- startofpacket
			in_endofpacket    : in  std_logic                     := 'X';             -- endofpacket
			in_channel        : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- channel
			out_data          : out std_logic_vector(29 downto 0);                    -- data
			out_valid         : out std_logic;                                        -- valid
			out_ready         : in  std_logic                     := 'X';             -- ready
			out_startofpacket : out std_logic;                                        -- startofpacket
			out_endofpacket   : out std_logic                                         -- endofpacket
		);
	end component Custom_qsys_vga_subsystem_avalon_st_adapter_channel_adapter_0;
...
begin
	...
	indatawidth_check : if inDataWidth /= 30 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	inchannelwidth_check : if inChannelWidth /= 2 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	outdatawidth_check : if outDataWidth /= 30 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	channel_adapter_0 : component Custom_qsys_vga_subsystem_avalon_st_adapter_channel_adapter_0
		port map (
...
end architecture rtl; -- of Custom_qsys_vga_subsystem_avalon_st_adapter
